...
const NAV_SECTIONS = [
  {
    ...
    label: 'CMS',
    items: [
      { label: 'Posts', to: '/admin/cms/posts', icon: 'document', requiredPermission: 'cms.manage' },
      { label: 'Taxonomy', to: '/admin/cms/taxonomy', icon: 'tag', requiredPermission: 'cms.manage' },
      { label: 'Pages', to: '/admin/cms/pages', icon: 'layout', requiredPermission: 'cms.pages.view' },
      { label: 'Images', to: '/admin/cms/images', icon: 'image', requiredPermission: 'cms.images.view' },
      { label: 'Layouts', to: '/admin/cms/layouts', icon: 'layers', requiredPermission: 'cms.layouts.manage' },
      { label: 'Widgets', to: '/admin/cms/widgets', icon: 'grid', requiredPermission: 'cms.widgets.view' },
      { label: 'Styles', to: '/admin/cms/styles', icon: 'appearance', requiredPermission: 'cms.styles.manage' },
      { label: 'Routing Rules', to: '/admin/cms/routing-rules', icon: 'git-branch', requiredPermission: 'cms.configure' },
      { label: 'SEO', to: '/admin/cms/seo', icon: 'search', requiredPermission: 'cms.manage' },
    ],
  },
];
